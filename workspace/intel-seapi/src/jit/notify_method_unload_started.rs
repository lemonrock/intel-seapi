...
#[inline(always)]
pub fn notify_method_unload_started(event_data: &mut iJIT_Method_Load)
{
	unsafe { iJIT_NotifyEvent(iJIT_JVM_EVENT::iJVM_EVENT_TYPE_METHOD_UNLOAD_START, event_data as *mut iJIT_Method_Load as *mut _) };
}
